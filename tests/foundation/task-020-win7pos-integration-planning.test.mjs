...
test("TASK-020 planning artifacts exist and are reconciled to DONE", () => {
  ...
  assert.match(
    masterPlan,
    /Task attivo: `NONE`|Task attivo: `TASK-021 - POS backend session\/device endpoints`|Task attivo: `TASK-022_023 - POS live dashboard \+ Win7POS first login trusted device`/,
  );
});
