...
test("TASK-079 is the only current root task for history and catalog pagination", () => {
  ...
  assert.match(
    currentBlock,
    /File task corrente:\s+`(NESSUNO|docs\/TASKS\/TASK-084-admin-web-workers-dev-staging-auth-logout-win7pos-public-connection\.md|docs\/TASKS\/TASK-085-workers-dev-mobile-oauth-products-count-readiness\.md|docs\/TASKS\/TASK-086-mobile-ui-emulator-polish\.md|docs\/TASKS\/TASK-137-product-catalog-images-cross-platform\.md|docs\/TASKS\/TASK-138-product-images-runtime-completion-ux-live-parity\.md|docs\/TASKS\/TASK-139-pos-catalog-v2-pagination-snapshot\.md|docs\/TASKS\/TASK-141-win7pos-catalog-bootstrap-staging-incident\.md|docs\/TASKS\/TASK-142-cross-platform-catalog-text-integrity\.md|docs\/TASKS\/TASK-143-admin-staging-catalog-pull-503\.md|docs\/TASKS\/TASK-144-pos-offline-authorization-attestation\.md|docs\/TASKS\/TASK-145-pos-article-mutation-v1\.md|docs\/TASKS\/TASK-146-pos-revision-canonicalization-asus-cleanup\.md|docs\/TASKS\/TASK-147-admin-staging-worker-cpu-remediation\.md|docs\/TASKS\/TASK-149-admin-trusted-pos-product-image-v1\.md|docs\/TASKS\/TASK-150-win7pos-product-image-phase-b-physical-acceptance\.md|docs\/TASKS\/TASK-151-wechat-006-shared-public-staging-closeout\.md|docs\/TASKS\/TASK-152-mobile-storefront-authoring-boundary\.md|docs\/TASKS\/TASK-153-client-commerce-address-delivery-payment-contract\.md|docs\/TASKS\/TASK-157-client-commerce-staging-e2e-closeout\.md)`/,
  );
  assert.match(
    currentBlock,
    /Evidence task corrente: `(NESSUNO|docs\/TASKS\/EVIDENCE\/TASK-084\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-085\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-086\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-137\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-138\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-139\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-141\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-142\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-143\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-144\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-145\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-146\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-147\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-149\/README\.md|docs\/TASKS\/EVIDENCE\/TASK-150\/README\.md|docs\/AUDITS\/WECHAT-006-WORKLOG\.md)`/,
  );
  assert.match(
    currentBlock,
    /Task attivo: `(NESSUNO|TASK-084 - Admin Web workers\.dev staging, auth\/logout fixes, and Win7POS public connection|TASK-085 - Fix workers\.dev mobile OAuth and product totals readiness|TASK-086 - Mobile UI Emulator Polish|TASK-137 - Product Catalog Images cross-platform|TASK-138 - Product Images Runtime Completion, UX e Live Parity|TASK-139 - POS Catalog v2 Pagination and Snapshot Correctness|TASK-141 - Win7POS catalog bootstrap staging incident|TASK-142 - Cross-platform catalog text integrity|TASK-143 - Admin staging catalog pull 503|TASK-144 - POS offline authorization attestation|TASK-145 - Versioned POS article mutation contract|TASK-146 - Canonical POS revision timestamps and Asus cleanup|TASK-147 - Admin staging Worker CPU remediation|TASK-149 - Trusted POS product image v1 server contract|TASK-150 - Win7POS Product Image Phase B \/ Physical Acceptance|TASK-151 - WECHAT-006 Shared Public Staging Activation and Closeout|TASK-152 - Mobile Storefront Authoring Boundary|TASK-153 - Client Commerce Address, Delivery and Payment Contract|TASK-157 - Client Commerce Staging E2E and Closeout)`/,
  );
