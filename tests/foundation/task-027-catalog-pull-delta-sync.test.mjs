...
test("TASK-027 governance artifacts document contract, evidence and DONE reconciliation", () => {
  ...
  assert.match(
    masterPlan,
    /Task attivo: `NESSUNO`|Task attivo: `TASK-028 - Catalog CRUD, Excel import\/export, and Win7POS catalog pull E2E`|Task attivo: `TASK-029 - Production path: staging, Win7POS bootstrap, POS API hardening`/,
  );
