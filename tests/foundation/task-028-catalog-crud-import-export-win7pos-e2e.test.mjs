...
test("TASK-028 governance artifacts close after explicit DONE reconciliation", () => {
  ...
  assert.match(
    masterPlan,
    /Stato task: `PLANNED`|Stato task: `REVIEW`|Stato task: `EXECUTION`|Stato task: `REVIEW_WITH_BLOCKERS`|Stato task: `REVIEW_WITH_EXTERNAL_BLOCKERS`|Stato task: `READY_FOR_WIN7_MANUAL_TEST`|Stato task: `DONE`/,
  );
