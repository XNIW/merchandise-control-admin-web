...
test("TASK-035 artifacts define authenticated Shop Admin QA scope and DONE handoff", () => {
  ...
  assert.match(
    masterPlan,
    /Ultimo task completato: `TASK-035|Ultimo task completato: `TASK-036|Ultimo task completato: `TASK-037|Ultimo task completato: `TASK-038|Ultimo task completato: `TASK-039|Ultimo task completato: `TASK-054|Ultimo task completato: `TASK-056|Ultimo task completato: `TASK-057|Ultimo task completato: `TASK-059|Ultimo task completato: `TASK-060/,
  );
