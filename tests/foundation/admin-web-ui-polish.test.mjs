...
test("TASK-013 UI/UX polish is reconciled to DONE", () => {
  ...
  assert.match(
    masterPlan,
    /Fase: `IDLE`|Fase: `PLANNING`|Fase: `EXECUTION`|Fase: `REVIEW`|Fase: `REVIEW_READY_FOR_DONE_CONFIRMATION`|Fase: `READY_FOR_DONE_CONFIRMATION`|Fase: `DONE_RECONCILED`|Fase: `DONE`/,
  );
});
