...
test("TASK-014 governance artifacts are active", () => {
  ...
  assert.match(
    masterPlan,
    /Fase: `(PLANNING|EXECUTION|REVIEW|REVIEW_WITH_BLOCKERS|REVIEW_WITH_EXTERNAL_BLOCKERS|IDLE|REVIEW_READY_FOR_DONE_CONFIRMATION|READY_FOR_DONE_CONFIRMATION|DONE_RECONCILED|DONE)`/,
  );
});
