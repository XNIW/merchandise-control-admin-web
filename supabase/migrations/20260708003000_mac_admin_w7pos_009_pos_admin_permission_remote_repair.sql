-- MAC-ADMIN-W7POS-009 repair: ensure POS Admin has the complete POS/staff permission set.
-- Some staging environments recorded the earlier repair version before all
-- permissions were present. Keep this additive and idempotent.
