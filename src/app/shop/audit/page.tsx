...
export default async function ShopAuditPage({
  ...
  return (
    <div className="grid gap-5">
      <ShopSectionPage
        beforeLiveData={
          <form className="grid gap-3 rounded-md border border-zinc-200 bg-white p-4 shadow-sm md:grid-cols-[minmax(0,1fr)_180px_180px_minmax(0,1fr)_auto]">
            {requestedShopId ? (
            ...
            <label className="grid gap-1 text-sm font-medium text-zinc-800">
              ...
              >
                ...
                <option value="warning">
                  {translateText(dictionary, "Warning")}
                </option>
                <option value="critical">
                  {translateText(dictionary, "Critical")}
                </option>
              </select>
            </label>
            <label className="grid gap-1 text-sm font-medium text-zinc-800">
              ...
              >
                ...
                <option value="blocked">
                  {translateText(dictionary, "Blocked")}
                </option>
                <option value="failure">
                  {translateText(dictionary, "Failure")}
                </option>
              </select>
            </label>
            <label className="grid gap-1 text-sm font-medium text-zinc-800">
