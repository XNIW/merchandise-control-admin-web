...
export const metadata: Metadata = {
  title: "POS Live | MerchandiseControl Admin Web",
  description: "Shop Admin POS live dashboard for MerchandiseControl Admin Web.",
};
...
export default async function ShopPosLivePage({
  searchParams,
}: {
