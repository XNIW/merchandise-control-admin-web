...
const itExact: Record<string, string> = {
  ...
  Last: "Ultima",
  "Loading product image": "Caricamento immagine prodotto",
  ...
  "No product image": "Nessuna immagine prodotto",
  Page: "Pagina",
  "Platform": "Piattaforma",
  "Pricing / stock": "Prezzi / stock",
  "Product identity": "Identita prodotto",
  "Product image unavailable": "Immagine prodotto non disponibile",
  ...
  "Courier Mode": "Modalita corriere",
  ...
  "WeChat iOS Return": "Ritorno WeChat iOS",
  "POS / Staff": "POS / Staff",
  "Incassi POS": "Incassi POS",
  "POS Live": "POS Live",
  "Products": "Prodotti",
  "Present": "Presente",
  ...
  "PIN": "PIN",
  "PIN (6 digits)": "PIN (6 cifre)",
  "POS Admin": "Amministratore POS",
  "Password": "Password",
  ...
  "Applying this supplier import will create or update a mobile History Entry for the selected shop.":
    "Applicando questo import fornitore verra creata o aggiornata una History Entry mobile per il negozio selezionato.",
  "History Entry created": "History Entry creata",
  "History Entry updated": "History Entry aggiornata",
  "Open History Entry": "Apri History Entry",
  "None": "Nessuno",
  ...
  "Applied": "Applicato",
  "Categories applied": "Categorie applicate",
  "Changed rows": "Righe modificate",
  "Detected": "Rilevato",
  "Errors / warnings": "Errori / warning",
  "Failed rows": "Righe fallite",
  "History Entry": "History Entry",
  "Invalid quantity/price problems": "Problemi quantita/prezzo non validi",
  "Latest sync event": "Ultimo evento sync",
  "Mapping problems": "Problemi mapping",
  "Missing rows": "Righe mancanti",
  "No match": "Nessun match",
  "Price history applied": "Storico prezzi applicato",
  "Products applied": "Prodotti applicati",
  "Rows created": "Righe create",
  "Rows skipped": "Righe saltate",
  "Rows updated": "Righe aggiornate",
  "Supplier import apply result.": "Risultato applicazione import fornitore.",
  "Supplier workbook apply": "Applicazione workbook fornitore",
  "Sync / Import analysis": "Analisi Sync / Import",
  "Sync analysis": "Analisi sync",
  "Sync status": "Stato sync",
  "Suppliers applied": "Fornitori applicati",
  "Total rows": "Righe totali",
  "Warnings / problems": "Warning / problemi",
  "Real data from shared_sheet_sessions and related sync_events.":
    "Dati reali da shared_sheet_sessions e sync_events collegati.",
...
const esExact: Record<string, string> = {
  ...
  Last: "Ultima",
  "Loading product image": "Cargando imagen del producto",
  ...
  "No product image": "Sin imagen del producto",
  Page: "Pagina",
  "Platform": "Plataforma",
  "Pricing / stock": "Precios / stock",
  "Product identity": "Identidad de producto",
  "Product image unavailable": "Imagen del producto no disponible",
  "Reset filters": "Restablecer filtros",
  "Retry image": "Reintentar imagen",
  ...
  "Account Deletion": "Eliminacion de cuenta",
  "WeChat iOS Return": "Retorno de WeChat en iOS",
  "POS / Staff": "POS / Staff",
  "Incassi POS": "Ingresos POS",
  "POS Live": "POS Live",
  "Products": "Productos",
  "Present": "Presente",
  ...
  "PIN": "PIN",
  "PIN (6 digits)": "PIN (6 dígitos)",
  "POS Admin": "Administrador POS",
  "Password": "Contraseña",
  ...
  "No.": "N.",
  "Applying this supplier import will create or update a mobile History Entry for the selected shop.":
    "Al aplicar esta importacion de proveedor se creara o actualizara una History Entry mobile para la tienda seleccionada.",
  "History Entry created": "History Entry creada",
  "History Entry updated": "History Entry actualizada",
  "Open History Entry": "Abrir History Entry",
  "None": "Ninguno",
  ...
  "Applied": "Aplicado",
  "Categories applied": "Categorias aplicadas",
  "Changed rows": "Filas modificadas",
  "Detected": "Detectado",
  "Errors / warnings": "Errores / advertencias",
  "Failed rows": "Filas fallidas",
  "History Entry": "History Entry",
  "Invalid quantity/price problems": "Problemas de cantidad/precio invalidos",
  "Latest sync event": "Ultimo evento sync",
  "Mapping problems": "Problemas de mapeo",
  "Missing rows": "Filas faltantes",
  "No match": "Sin match",
  "Price history applied": "Historial de precios aplicado",
  "Products applied": "Productos aplicados",
  "Rows created": "Filas creadas",
  "Rows skipped": "Filas omitidas",
  "Rows updated": "Filas actualizadas",
  "Supplier import apply result.": "Resultado de aplicar import de proveedor.",
  "Supplier workbook apply": "Aplicacion de workbook de proveedor",
  "Sync / Import analysis": "Analisis Sync / Import",
  "Sync analysis": "Analisis sync",
  "Sync status": "Estado sync",
  "Suppliers applied": "Proveedores aplicados",
  "Total rows": "Filas totales",
  "Warnings / problems": "Advertencias / problemas",
  "Real data from shared_sheet_sessions and related sync_events.":
    "Datos reales de shared_sheet_sessions y sync_events relacionados.",
...
const zhExact: Record<string, string> = {
  ...
  Last: "最后一页",
  "Loading product image": "正在加载商品图片",
  ...
  "No product image": "暂无商品图片",
  Page: "页面",
  "Platform": "平台",
  "Pricing / stock": "价格 / 库存",
  "Product identity": "商品身份",
  "Product image unavailable": "商品图片不可用",
  "Reset filters": "重置筛选",
  "Retry image": "重试图片",
  ...
  "No.": "序号",
  "Applying this supplier import will create or update a mobile History Entry for the selected shop.":
    "应用此供应商导入会为所选店铺创建或更新移动端 History Entry。",
  "History Entry created": "History Entry 已创建",
  "History Entry updated": "History Entry 已更新",
  "Open History Entry": "打开 History Entry",
  "None": "无",
  "Open Products": "打开商品",
  ...
  "Result summary": "结果摘要",
  "Applied": "已应用",
  "Categories applied": "已应用分类",
  "Changed rows": "已更改行",
  "Detected": "已检测",
  "Errors / warnings": "错误 / 警告",
  "Failed rows": "失败行",
  "History Entry": "History Entry",
  "Invalid quantity/price problems": "数量/价格无效问题",
  "Latest sync event": "最新同步事件",
  "Mapping problems": "映射问题",
  "Missing rows": "缺失行",
  "No match": "无匹配",
  "Price history applied": "已应用价格历史",
  "Products applied": "已应用商品",
  "Rows created": "已创建行",
  "Rows skipped": "已跳过行",
  "Rows updated": "已更新行",
  "Supplier import apply result.": "供应商导入应用结果。",
  "Supplier workbook apply": "供应商 workbook 应用",
  "Sync / Import analysis": "同步 / 导入分析",
  "Sync analysis": "同步分析",
  "Sync status": "同步状态",
  "Suppliers applied": "已应用供应商",
  "Total rows": "总行数",
  "Warnings / problems": "警告 / 问题",
  "Real data from shared_sheet_sessions and related sync_events.":
    "来自 shared_sheet_sessions 及相关 sync_events 的真实数据。",
...
const itRenderedCorrectiveExact: Record<string, string> = {
  ...
  "Device Detail": "Dettaglio dispositivo",
  "History Detail": "Dettaglio storico",
  ...
  "Counted Qty": "Quantita contata",
  "Delta": "Delta",
  "In catalog": "In catalogo",
  "Old purchase": "Acquisto vecchio",
  "Old retail": "Vendita vecchia",
  "Open": "Apri",
  "Partial": "Parziale",
  ...
  "Active + issues": "Attive + problemi",
  "All time": "Tutto il periodo",
  "Archived products remain restorable from Advanced":
    "I prodotti archiviati restano ripristinabili da Avanzato",
  "Client-side filters apply only to visible rows. Rows and diagnostics load when opening Detail.":
    "I filtri client-side si applicano solo alle righe visibili. Righe e diagnostica si caricano aprendo Detail.",
  "Editing product": "Modifica prodotto",
  "Diagnostics not available": "Diagnostica non disponibile",
  "Entry date": "Data voce",
  "Entry name, supplier, category": "Nome voce, fornitore, categoria",
  "Exact shared_sheet_sessions total": "Totale esatto shared_sheet_sessions",
  "Exact total unavailable; loaded rows are shown separately":
    "Totale esatto non disponibile; le righe caricate sono mostrate separatamente",
  "First render uses the bounded light list":
    "Il primo render usa la lista leggera limitata",
  "Issues": "Problemi",
  "Items": "Articoli",
  "Last 3 months": "Ultimi 3 mesi",
  "Latest product row update visible to Admin Web":
    "Ultimo aggiornamento riga prodotto visibile in Admin Web",
  "Legacy mobile bridge is in use": "Bridge mobile legacy in uso",
  "Mapped to mobile inventory": "Mappato all'inventario mobile",
  "Mapping state is not available": "Stato mapping non disponibile",
  "Mobile visible": "Visibili mobile",
  "Month": "Mese",
  "No history entries match these filters.":
    "Nessuna voce storico corrisponde a questi filtri.",
  "No mobile inventory mapping is active":
    "Nessun mapping inventario mobile attivo",
  "Search history": "Cerca nello storico",
  "Source used by the admin product read model":
    "Fonte usata dal read model prodotti admin",
  "Summary loads from Detail": "Il riepilogo si carica da Detail",
  "Technical": "Tecniche",
  "Technical history entry": "Voce storico tecnica",
  "Technical rows stay out of default view":
    "Le righe tecniche restano fuori dalla vista predefinita",
  "Default view hides technical rows":
    "La vista predefinita nasconde le righe tecniche",
  "Loaded rows": "Righe caricate",
  "This month": "Questo mese",
  "Unknown month": "Mese sconosciuto",
  "Visible entries": "Voci visibili",
...
const esRenderedCorrectiveExact: Record<string, string> = {
  ...
  "Device Detail": "Detalle dispositivo",
  "History Detail": "Detalle historial",
  ...
  "Delta": "Delta",
  "In catalog": "En catalogo",
  "Old purchase": "Compra anterior",
  "Old retail": "Venta anterior",
  "Open": "Abrir",
  "Partial": "Parcial",
  "Row total": "Total fila",
  ...
  "Identity": "Identidad",
  "Inventory / Sync": "Inventario / Sync",
  "Active + issues": "Activas + problemas",
  "All time": "Todo el periodo",
  "Archived products remain restorable from Advanced":
    "Los productos archivados siguen restaurables desde Avanzado",
  "Client-side filters apply only to visible rows. Rows and diagnostics load when opening Detail.":
    "Los filtros client-side se aplican solo a las filas visibles. Las filas y el diagnostico se cargan al abrir Detail.",
  "Editing product": "Editando producto",
  "Diagnostics not available": "Diagnostico no disponible",
  "Entry date": "Fecha de entrada",
  "Entry name, supplier, category": "Nombre de entrada, proveedor, categoria",
  "Exact shared_sheet_sessions total": "Total exacto de shared_sheet_sessions",
  "Exact total unavailable; loaded rows are shown separately":
    "Total exacto no disponible; las filas cargadas se muestran por separado",
  "First render uses the bounded light list":
    "El primer render usa la lista ligera limitada",
  "Issues": "Problemas",
  "Items": "Articulos",
  "Last 3 months": "Ultimos 3 meses",
  "Latest product row update visible to Admin Web":
    "Ultima actualizacion de fila producto visible en Admin Web",
  "Legacy mobile bridge is in use": "Bridge mobile legacy en uso",
  "Mapped to mobile inventory": "Mapeado al inventario mobile",
  "Mapping state is not available": "Estado de mapeo no disponible",
  "Mobile visible": "Visibles mobile",
  "Month": "Mes",
  "No history entries match these filters.":
    "Ninguna entrada de historial coincide con estos filtros.",
  "No mobile inventory mapping is active":
    "No hay mapeo de inventario mobile activo",
  "Search history": "Buscar historial",
  "Source used by the admin product read model":
    "Fuente usada por el read model admin de productos",
  "Summary loads from Detail": "El resumen se carga desde Detail",
  "Technical": "Tecnicas",
  "Technical history entry": "Entrada de historial tecnica",
  "Technical rows stay out of default view":
    "Las filas tecnicas quedan fuera de la vista predeterminada",
  "Default view hides technical rows":
    "La vista predeterminada oculta las filas tecnicas",
  ...
  "Stock": "Stock",
  "Supplier Qty": "Cant. proveedor",
  "Supplier not set": "Proveedor no configurado",
  "Sync event": "Evento sync",
  "Sync issue": "Problema sync",
  "Sync state not available": "Estado sync no disponible",
  ...
  "Supplier Detail": "Detalle proveedor",
  "Support Diagnostics": "Diagnostico de soporte",
...
const zhRenderedCorrectiveExact: Record<string, string> = {
  ...
  "Archived products remain restorable from Advanced":
    "已归档商品仍可从高级中恢复",
  "Client-side filters apply only to visible rows. Rows and diagnostics load when opening Detail.":
    "客户端筛选仅应用于当前可见行。行和诊断会在打开详情时加载。",
  "Editing product": "正在编辑商品",
  "Diagnostics not available": "诊断不可用",
  "Entry date": "条目日期",
  "Entry name, supplier, category": "条目名称、供应商、分类",
  "Exact shared_sheet_sessions total": "shared_sheet_sessions 精确总数",
  "Exact total unavailable; loaded rows are shown separately":
    "精确总数不可用；已加载行会单独显示",
  "First render uses the bounded light list": "首屏使用有上限的轻量列表",
  "Issues": "问题",
  "Items": "商品数",
  "Last 3 months": "最近 3 个月",
  "Latest product row update visible to Admin Web":
    "Admin Web 可见的最新商品行更新",
  "Legacy mobile bridge is in use": "正在使用旧版移动端桥接",
  "Mapped to mobile inventory": "已映射到移动端库存",
  "Mapping state is not available": "映射状态不可用",
  "Mobile visible": "移动端可见",
  "Month": "月份",
  "No history entries match these filters.": "没有历史条目匹配这些筛选条件。",
  "No mobile inventory mapping is active": "没有启用移动端库存映射",
  "Search history": "搜索历史",
  "Source used by the admin product read model": "Admin 商品读取模型使用的来源",
  "Summary loads from Detail": "摘要会从详情加载",
  "Technical": "技术项",
  "Technical history entry": "技术历史条目",
  "Technical rows stay out of default view": "技术行不会出现在默认视图中",
  "Default view hides technical rows": "默认视图会隐藏技术行",
  "Loaded rows": "已加载行",
  "This month": "本月",
  "Unknown month": "未知月份",
  ...
  "Sync event": "同步事件",
  "Sync issue": "同步问题",
  "Sync state not available": "同步状态不可用",
  "Sync state": "同步状态",
  "Synced": "已同步",
  "Total quantity": "总数量",
